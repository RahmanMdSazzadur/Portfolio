  ...
  try {
    ...
    const result: AgentRunResult = {
      ...
      logs: [
        ...
        `[Job Discovery]  Searched Adzuna for "${jobTitle}" in "${location || "Remote"}"`,
        `[Job Discovery]  Found ${mockJobs.length} matching roles`,
        `[Recruiter]      Resolved 2 / ${mockJobs.length} recruiter emails via Hunter.io`,
        `[Email Gen]      Generated personalised cold emails using GPT-4o`,
        `[Email Sender]   Sent 1 email via Gmail API — daily limit respected`,
