...
>(
  (
    ...
    return (
      <div
        ref={mergedRef}
        className={`min-h-[80vh] w-full relative flex items-center justify-center overflow-hidden ${className}`}
        {...rest}
      >
        <div
              ...
              return (
                <li
                  ...
                  style={{
                    ...
                    transform: `translate(-50%, -50%) translate3d(${x.toFixed(2)}px, ${y.toFixed(2)}px, 0px) rotate(${(rotationAngle + 90).toFixed(2)}deg)`,
                  }}
                >
                  {/* 
                  ...
                  */}
                  <div
                    ...
                    className={`
                      ...
                      rounded-[2rem] transition-all duration-500 ease-out will-change-transform
                      ${isHovered ? 'scale-125 -translate-y-8 shadow-[0_20px_40px_rgba(0,0,0,0.5)]' : 'scale-100 shadow-md'}
                      ${
